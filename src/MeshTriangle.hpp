...
public:
    ...
    MeshTriangle(const std::string& filename, std::shared_ptr<Material> mt,  std::string n = "")
    {
        objl::Loader loader;
    ...
    MeshTriangle(const std::string& filename, Vector3f tran, Vector3f scale, Vector3f xRotate, Vector3f yRotate, Vector3f zRotate, std::shared_ptr<Material> mt, std::string n = "")
    {
        objl::Loader loader;
        loader.LoadFile(filename);
        area = 0;
